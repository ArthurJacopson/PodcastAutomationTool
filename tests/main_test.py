...
class test_main(unittest.TestCase):
    ...
    def setUp(self):
        self.audio_input_filepath = os.path.abspath(
            './sample-files/audio/sample1.mp3')
        self.video_input_filepath = os.path.abspath(
            './sample-files/video/sample.mp4')
        self.video2_input_filepath = os.path.abspath(
            './sample-files/video/goat.mp4')
    ...
    #     trim(self.video_input_filepath,
    #          self.video_output_filepath, 0.1, 0.2, 'mp4')
    #     self.assertTrue(os.path.exists(self.video_output_filepath),
    #                     "trim failed to produce a video file.")
    #     trimmed_duration = self.get_video_duration(self.video_output_filepath)
    #     self.assertTrue(trimmed_duration == 0.1,
    #                     f"Duration of trimmed video is {trimmed_duration} instead of the expected 0.1")
    ...
    #                     "audio_trim failed to produce an audio file.")
    #     trimmed_duration = self.get_audio_duration(self.audio_output_filepath)
    #     self.assertTrue(trimmed_duration == 0.1,
    #                     f"Duration of trimmed audio is {trimmed_duration} instead of the expected 0.1")
